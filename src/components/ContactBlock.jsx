...
export default function ContactBlock({ title, data, onChange, primaryData, required = true }) {
  ...
  return (
    <div className="sub-card">
      ...
      <label className="cb-wrap">
        <input type="checkbox" checked={data.sameAsPrimary} onChange={handleSameAsPrimary} />
