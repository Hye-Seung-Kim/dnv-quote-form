...
export default function Step3({ errors = {} }) {
  ...
  const upInvoicing = (val) =>
    setForm((f) => ({ ...f, invoicing: { ...f.invoicing, ...val } }));
  ...
  return (
    <div className="card">
      ...
      <ContactBlock
        ...
        data={form.directorOfQuality}
        onChange={(v) => up("directorOfQuality", v)}
        primaryData={form}
        required={false}
      />
      ...
      <div className="sub-card">
        ...
        <div className="field-row">
          <Field label="First Name" required error={errors.invoicingFirstName}>
            <input
              ...
              onChange={(e) => upInvoicing({ firstName: e.target.value })}
            />
          </Field>
          ...
          <Field label="Last Name" required error={errors.invoicingLastName}>
            <input
              ...
              onChange={(e) => upInvoicing({ lastName: e.target.value })}
            />
          </Field>
        </div>
        ...
        <Field label="Phone" required error={errors.invoicingPhone}>
          <input
            ...
            onChange={(e) =>
              upInvoicing({ phone: formatPhoneNumber(e.target.value) })
            }
          />
        </Field>
        ...
        <Field label="Email" required error={errors.invoicingEmail}>
          <input
            ...
            onChange={(e) => upInvoicing({ email: e.target.value })}
          />
        </Field>

        <div className="section-title" style={{ fontSize: 14, marginBottom: 10 }}>
          Billing Address
        </div>
        ...
        <Field label="Street Address" required error={errors.invoicingStreetAddress}>
          <input
            ...
            onChange={(e) => upInvoicing({ streetAddress: e.target.value })}
          />
        </Field>
        ...
        <div className="field-row-3">
          <Field label="City" required error={errors.invoicingCity}>
            <input
              ...
              onChange={(e) => upInvoicing({ city: e.target.value })}
            />
          </Field>
          ...
          <Field label="ZIP Code" required error={errors.invoicingZip}>
            <input
              ...
              onChange={(e) => upInvoicing({ zip: e.target.value })}
            />
          </Field>
        </div>
      </div>
